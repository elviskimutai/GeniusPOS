   ...
   // public String RegSource,UserID;
     ...
     Constants _Constants=new Constants();
       ...
       List<ItemCombo> Items = null;
         DefaultTableModel model = new DefaultTableModel(new String[]{ "Item", "ItemName","Suplier","CostPrice","Quantity","VAT","TotalCost","DeliveryDate"}, 0);
...
public void fillSupliers(){
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createTitledBorder(""), "Purchase Orders Details", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 14), new java.awt.Color(51, 51, 255))); // NOI18N
    ...
    private void BTNAddItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTNAddItemActionPerformed
        // TODO add your handling code here:
            ...
            if(rows==0){
               ...
               Double TotalCost=(CostPrice*Quantity)+tax;
              ...
              model.addRow(new Object[]{Item, ItemName,Suplier,CostPrice,Quantity,tax,TotalCost,DelDate});
           ...
           for(int row = 0; row<rows; row++)
            {
                ...
                Double TotalCost = Double.parseDouble(String.valueOf(POtable.getValueAt(row, 6)));
                 Double VAT = Double.parseDouble(String.valueOf(POtable.getValueAt(row, 5)));
                Date DeliverBy= (Date)POtable.getValueAt(row, 7);
                _Constants.setPOCODE(POCOD);
                
                 
              PurchaseOrder _PurchaseOrder=new PurchaseOrder( POCOD,  Item,  Suplier,  Qty,  CostPrice,  TotalCost,  DeliverBy,VAT);
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        try {
            ...
            for (PoItems _PoItems : _PurchaseOrder.PrintPO()) {
                ...
                row.put("Tax", _PoItems.getTax());
                row.put("UOM",_PoItems.getUOM());
                row.put("POCode",POCODE.getText());
                
                 String ComapnyWebsite=_PoItems.getComapnyWebsite();
                String CompanyPhysical=_PoItems.getCompanyPhysical();
